...
const { getProfile, updateProfile, changePassword, extractSkills, completeOnboarding } = require('../controllers/profileController');
...
router.patch('/complete-onboarding', protect, authorize('jobSeeker'), completeOnboarding);
